	...
	var ProfileNewPage = (function (_Component) {
	    ...
	    _createClass(ProfileNewPage, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement('div', null, _react2['default'].createElement('header', { className: 'header' }, _react2['default'].createElement('div', { className: 'logo' }, _react2['default'].createElement('img', { src: '/static/images/pitch/pitchaman_dashboard_logo.png', className: 'img-responsive' })), _react2['default'].createElement(_reusableSearchSearch2['default'], { onClickEnter: this.search })), _react2['default'].createElement('div', { className: 'container-fluid' }, _react2['default'].createElement('div', { className: 'row' }, _react2['default'].createElement('div', { className: 'tabs-right' }, _react2['default'].createElement('div', { className: 'col-md-12' }, _react2['default'].createElement(_reactBootstrap.Tabs, { defaultActiveKey: 1 }, _react2['default'].createElement(_reactBootstrap.Tab, { eventKey: 1, title: 'Investor' }, _react2['default'].createElement(_formsInvestorForm2['default'], null)), _react2['default'].createElement(_reactBootstrap.Tab, { eventKey: 2, title: 'StartUp' }, _react2['default'].createElement(_formsStartupForm2['default'], null))))))));
	        }
	    }]);
