...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formsStartupForm = __webpack_require__(429);
	...
	var ProfileNewPage = (function (_Component) {
	    ...
	    _createClass(ProfileNewPage, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement('div', null, _react2['default'].createElement('header', { className: 'header' }, _react2['default'].createElement('div', { className: 'logo' }, _react2['default'].createElement('img', { src: '/static/images/pitch/pitchaman_dashboard_logo.png', className: 'img-responsive' }))), _react2['default'].createElement('div', { className: 'container-fluid' }, _react2['default'].createElement('div', { className: 'row' }, _react2['default'].createElement('div', { className: 'tabs-right' }, _react2['default'].createElement('div', { className: 'col-md-12' }, _react2['default'].createElement(_reactBootstrap.Tabs, { defaultActiveKey: 1 }, _react2['default'].createElement(_reactBootstrap.Tab, { eventKey: 1, title: 'Investor' }, _react2['default'].createElement(_formsInvestorForm2['default'], null)), _react2['default'].createElement(_reactBootstrap.Tab, { eventKey: 2, title: 'StartUp' }, _react2['default'].createElement(_formsStartupForm2['default'], null))))))));
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCountryState = __webpack_require__(419);

	var _reactToggle = __webpack_require__(420);
	...
	var InvestorForm = (function (_Component) {
	    ...
	    function InvestorForm() {
	        ...
	        this.toggle = function () {
	            var acceptedTerms = _this.state.acceptedTerms;
	            _this.setState({ acceptedTerms: !acceptedTerms });
	        };

	        this.getCountrySelected = function (country) {
	            _this.setState({ selectedCountry: country });
	        };

	        this.getStateSelected = function (state) {
	            _this.setState({ selectedState: state });
	        };

	        this.getAnnualSalary = function (val) {
	            _this.setState({ annualSalary: val });
	        };

	        this.getNetWorth = function (val) {
	            _this.setState({ netWorth: val });
	        };

	        this.submitForm = function () {
	            var investor_city = _this.refs.investor_city.value;
	            var investor_street = _this.refs.investor_street.value;
	            var investor_zip = _this.refs.investor_zip.value;
	            var investor_tel = _this.refs.investor_tel.value;
	            var investor_date = _this.refs.investor_date.value;
	            var selectedCountry = _this.state.selectedCountry;
	            var selectedState = _this.state.selectedState;
	            var netWorth = _this.state.netWorth;
	            var annualSalary = _this.state.annualSalary;
	            var acceptedTerms = _this.state.acceptedTerms;

	            if (acceptedTerms) {} else {
	    ...
	    _createClass(InvestorForm, [{
	        ...
	        value: function render() {
	            ...
	            var acceptedTerms = this.state.acceptedTerms;
	            return _react2['default'].createElement('div', null, _react2['default'].createElement('ul', { className: 'form-segment' }, _react2['default'].createElement('li', null, _react2['default'].createElement('div', { className: 'input-body' }, _react2['default'].createElement('div', { className: 'labels' }, _react2['default'].createElement('span', null, 'Name'), _react2['default'].createElement('span', null, 'Country'), _react2['default'].createElement('span', null, 'State'), _react2['default'].createElement('span', { className: 'add' }, 'Address'), _react2['default'].createElement('span', null, 'Phone'), _react2['default'].createElement('span', null, 'Birth Date')), _react2['default'].createElement('div', { className: 'inputs' }, _react2['default'].createElement('span', null, _react2['default'].createElement('input', { type: 'text', placeholder: 'Full Name', ref: 'investor_name' })), _react2['default'].createElement('span', null, _react2['default'].createElement(_reactSelect2['default'], {
	                name: 'form-field-name',
	                options: _utilsCountryState.countries,
	                placeholder: 'Country...',
	                ...
	                name: 'form-field-name',
	                options: _utilsCountryState.state,
	                placeholder: 'State....',
	                onChange: this.getStateSelected
	            })), _react2['default'].createElement('span', { className: 'add' }, _react2['default'].createElement('input', { type: 'text', placeholder: 'Street', ref: 'investor_street' }), _react2['default'].createElement('span', { className: 'inline' }, _react2['default'].createElement('input', { type: 'text', className: 'city', placeholder: 'City', ref: 'investor_city' }), _react2['default'].createElement('input', { type: 'text', className: 'zip', placeholder: 'Zip', ref: 'investor_zip' }))), _react2['default'].createElement('span', null, _react2['default'].createElement('input', { type: 'number', placeholder: '000-000-000-00', ref: 'investor_tel' })), _react2['default'].createElement('span', null, _react2['default'].createElement('input', { type: 'date', ref: 'investor_date' })))), _react2['default'].createElement('span', { className: 'toggle' }, _react2['default'].createElement('label', null, _react2['default'].createElement(_reactToggle2['default'], {
	                defaultChecked: acceptedTerms,
	                onChange: function onChange() {
	                    return _this2.toggle();
	                }
	            }), 'I agree to the ', _react2['default'].createElement('i', { className: 'blue' }, 'Terms'), ' of service and ', _react2['default'].createElement('i', { className: 'blue' }, 'Investor'), ' Agreement'))), _react2['default'].createElement('li', null, _react2['default'].createElement('div', { className: 'range-box blue' }, _react2['default'].createElement('header', { className: 'head' }, 'What\'s your network minus your home?'), _react2['default'].createElement('div', { className: 'body' }, _react2['default'].createElement(_reusableRangeCollectionRangeSlider2['default'], { onChange: this.getNetWorth }))), _react2['default'].createElement('div', { className: 'range-box orange' }, _react2['default'].createElement('header', { className: 'head' }, 'What\'s your annual salary?'), _react2['default'].createElement('div', { className: 'body' }, _react2['default'].createElement(_reusableRangeCollectionRangeSlider2['default'], { onChange: this.getAnnualSalary }))), _react2['default'].createElement('div', { className: 'submit-button' }, _react2['default'].createElement('button', { className: 'blue-button', onClick: function onClick() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classNames = _interopRequire(__webpack_require__(421));

	var Check = _interopRequire(__webpack_require__(422));

	var X = _interopRequire(__webpack_require__(423));

	var PureRenderMixin = _interopRequire(__webpack_require__(424));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shallowCompare = __webpack_require__(426);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StartUpForm = (function (_Component) {
	    ...
	    function StartUpForm() {
	        ...
	        _get(Object.getPrototypeOf(StartUpForm.prototype), 'constructor', this).call(this);
	    ...
	    _createClass(StartUpForm, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement('div', null, _react2['default'].createElement('ul', { className: 'form-segment' }, _react2['default'].createElement('li', null, _react2['default'].createElement('div', { className: 'input-body' }, _react2['default'].createElement('div', { className: 'labels' }, _react2['default'].createElement('span', null, 'Name'), _react2['default'].createElement('span', null, 'Country'), _react2['default'].createElement('span', null, 'State'), _react2['default'].createElement('span', { className: 'add' }, 'Address'), _react2['default'].createElement('span', null, 'Phone'), _react2['default'].createElement('span', null, 'Birth Date')), _react2['default'].createElement('div', { className: 'inputs' }, _react2['default'].createElement('span', null, _react2['default'].createElement('input', { type: 'text', placeholder: 'StartUp Name' })), _react2['default'].createElement('span', null, _react2['default'].createElement(_reactSelect2['default'], {
	                name: 'form-field-name',
	                options: options,
	                placeholder: 'Country...'
	            })), _react2['default'].createElement('span', null, _react2['default'].createElement(_reactSelect2['default'], {
	                ...
	                options: options,
	                placeholder: 'State....'
	            })), _react2['default'].createElement('span', { className: 'add' }, _react2['default'].createElement('input', { type: 'text', placeholder: 'Street' }), _react2['default'].createElement('span', { className: 'inline' }, _react2['default'].createElement('input', { type: 'text', className: 'city', placeholder: 'City' }), _react2['default'].createElement('input', { type: 'text', className: 'zip', placeholder: 'Zip' }))), _react2['default'].createElement('span', null, _react2['default'].createElement('input', { type: 'number', placeholder: '000-000-000-00' })), _react2['default'].createElement('span', null, _react2['default'].createElement('input', { type: 'date' })))), _react2['default'].createElement('span', { className: 'toggle' }, _react2['default'].createElement('label', null, _react2['default'].createElement(_reactToggle2['default'], {
	                defaultChecked: toggled,
	                onChange: function onChange() {
	                    return _this2.toggle();
	                }
	            }), 'I agree to the ', _react2['default'].createElement('i', { className: 'blue' }, 'Terms'), ' of service and ', _react2['default'].createElement('i', { className: 'blue' }, 'Startup'), ' Agreement'))), _react2['default'].createElement('li', null, _react2['default'].createElement('div', { className: 'range-box blue' }, _react2['default'].createElement('header', { className: 'head' }, 'What\'s your Startup\'s current valuation?'), _react2['default'].createElement('div', { className: 'body' }, _react2['default'].createElement(_reusableRangeCollectionRangeSlider2['default'], null))), _react2['default'].createElement('div', { className: 'range-box orange' }, _react2['default'].createElement('header', { className: 'head' }, 'What\'s your Startup\'s annual earning?'), _react2['default'].createElement('div', { className: 'body' }, _react2['default'].createElement(_reusableRangeCollectionRangeSlider2['default'], null))), _react2['default'].createElement('div', { className: 'submit-button' }, _react2['default'].createElement('button', { className: 'blue-button' }, 'Create Startup Account')))));
	        }
	    }]);
