	...
	var InvestorForm = (function (_Component) {
	    ...
	    _createClass(InvestorForm, [{
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement('div', null, _react2['default'].createElement('ul', { className: 'form-segment' }, _react2['default'].createElement('li', null, _react2['default'].createElement('div', { className: 'input-body' }, _react2['default'].createElement('div', { className: 'labels' }, _react2['default'].createElement('span', null, 'Name'), _react2['default'].createElement('span', null, 'Country'), _react2['default'].createElement('span', null, 'State'), _react2['default'].createElement('span', { className: 'add' }, 'Address'), _react2['default'].createElement('span', null, 'Phone'), _react2['default'].createElement('span', null, 'Birth Date')), _react2['default'].createElement('div', { className: 'inputs' }, _react2['default'].createElement('span', null, _react2['default'].createElement('input', { type: 'text', placeholder: 'Full Name' })), _react2['default'].createElement('span', null, _react2['default'].createElement(_reactSelect2['default'], {
	            ...
	            })), _react2['default'].createElement('span', { className: 'add' }, _react2['default'].createElement('input', { type: 'text', placeholder: 'Street' }), _react2['default'].createElement('span', { className: 'inline' }, _react2['default'].createElement('input', { type: 'text', className: 'city', placeholder: 'City' }), _react2['default'].createElement('input', { type: 'text', className: 'zip', placeholder: 'Zip' }))), _react2['default'].createElement('span', null, _react2['default'].createElement('input', { type: 'number', placeholder: '000-000-000-00', ref: 'tel' })), _react2['default'].createElement('span', null, _react2['default'].createElement('input', { type: 'date', ref: 'date' })))), _react2['default'].createElement('span', { className: 'toggle' }, _react2['default'].createElement('label', null, _react2['default'].createElement(_reactToggle2['default'], {
