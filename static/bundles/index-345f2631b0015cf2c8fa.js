	...
	var HomePage = (function (_Component) {
	    ...
	    _createClass(HomePage, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement('div', { className: 'home-bg' }, _react2['default'].createElement('div', { className: 'container-fluid' }, _react2['default'].createElement('header', { className: 'row idx-header' }, _react2['default'].createElement('div', { className: 'col-md-2 col-sm-3 col-xs-5' }, _react2['default'].createElement('div', { className: 'brand' }, _react2['default'].createElement('img', { src: '/static/images/pitch/pitchaman_logo.png', className: 'img-responsive' }), _react2['default'].createElement('div', { className: 'tagline' }, '...pitch now...get pitched'))), _react2['default'].createElement('div', { className: 'col-md-10 col-sm-9 col-xs-12' }, _react2['default'].createElement('div', { className: 'authLinks' }, _react2['default'].createElement('span', null, 'Login'), _react2['default'].createElement('span', null, 'Sign Up'))))));
	        }
	    }]);
