	...
	var HomePage = (function (_Component) {
	    ...
	    _createClass(HomePage, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement('div', { className: 'home-bg' }, _react2['default'].createElement('div', { className: 'container-fluid' }, _react2['default'].createElement('header', { className: 'row idx-header' }, _react2['default'].createElement('div', { className: 'col-md-2' }, _react2['default'].createElement('div', { className: 'brand' }, _react2['default'].createElement('img', { src: '/static/images/pitch/pitchaman_logo.png' }), _react2['default'].createElement('div', { className: 'tagline' }, '...pitch now...get pitched'))), _react2['default'].createElement('div', { className: 'col-md-10' }, _react2['default'].createElement('div', { className: 'authLinks' }, 'Login'), _react2['default'].createElement('div', { className: 'authLinks' }, 'SIgn Up')))));
	        }
	    }]);
